module.exports = {
    cancel: function (req, sql) {
        ...
        return new Promise((resolve, reject) => {
            ...
            sql.query(`UPDATE [playjeeto].[dbo].[TICKET99] set TARMINALCLS = 'CANCEL' where TICKETNUMBER= '${req["barcode"]}' and TARMINALCLS !='NOTWIN' and TARMINALCLS !='WIN' `)
                .then((data) => {


                    console.log(`SELECT * FROM [playjeeto].[dbo].[TICKET99] where TICKETNUMBER ='${req["barcode"]}'`);
                    sql.query(`SELECT * FROM [playjeeto].[dbo].[TICKET99] where TICKETNUMBER ='${req["barcode"]}'`).then((balancedata) => {
