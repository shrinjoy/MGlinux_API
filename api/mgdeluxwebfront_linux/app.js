...
if(getJSONCookie("macid")!==null)
{
  var macid={
    macid:getRandomNumber(1111111111,9999999999)
  }

  setJSONCookie("macid",macid,365);
}
  ...
  if (captchaInput === captcha) {
    axios({
      ...
      data: {
        ...
        username: name,
        password: pass,
        macid:getJSONCookie("macid")["macid"].toString()
      },
    })
      .then(function (res) {
...
document.getElementById("captchaInput").innerText="";
