module.exports = {
    cancel: function (req, sql) {
        return new Promise((resolve, reject) => {
            ...
            sql.query(`SELECT * FROM TICKET12CARD WHERE TICKETNUMBER='${req["barcode"]}'`).then((data) => {
                ...
                if (data.recordset.length < 1) {
                    ...
                    console.log("found a ticket that is cool to use");
                        ...
                        sql.query(`UPDATE TICKET12CARD SET TARMINALCLS='CANCEL' WHERE TICKETNUMBER='${req["barcode"]}' AND TARMINALID='${userid}'`)
                            .then((data) => {
